//
//  SwiftUIFrameStudyView.swift
//  wandaFilmSwiftUI
//
//  Created by 刁宏瑞 on 2021/6/15.
//

import SwiftUI

struct SwiftUIFrameStudyView: View {
...
struct SwiftUIFrameStudyView_Previews: PreviewProvider {
    static var previews: some View {
        SwiftUIFrameStudyView()
    }
}
